...
if isempty(robot_variable)
    ...
    SAILTARGET_MSG       = 'struct { float degrees; int reset_request;} sailTarget';
    FLAGS_MSG            = 'struct { int man_in_charge; int state; int state_requested; int sail_direction; int sailor_no_tack_or_jibe; int navi_state; long navi_index_call; long navi_index_answer; int sail_reset_index; int autonom_navigation; int global_locator; int joystick_timeout; } Flags';
    ...
    NAVIFLAGS_MSG        = 'struct { int navi_state; long navi_index_call; long navi_index_answer; int sail_reset_index;} NaviFlags';
    ...
    IMU_MSG              = 'struct { double speed; struct{ double longitude; double latitude; double altitude;} position; struct{ double roll; double pitch; double yaw;} attitude; struct{ double x; double y; double z;} velocity; struct{ double x; double y; double z;} acceleration; struct{ double x; double y; double z;} gyro; double temperature; } imuData';
